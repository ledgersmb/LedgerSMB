...
\begin{tabular*}{\textwidth}{@{}lp{\descrwidth}@{\extracolsep\fill}rlrrr@{}}
  ...
  & Übertrag von Seite <?lsmb lastpage ?> & & & & & <?lsmb sumcarriedforward ?> \\
<?lsmb end pagebreak ?>
...
\begin{tabular}[t]{l@{\hspace{0.3cm}}l}
  \textbf{Bestelldatum} & <?lsmb orddate ?> \\
<?lsmb if reqdate ?>
  \textbf{Lieferbar bei} & <?lsmb reqdate ?> \\
<?lsmb end reqdate ?>
  \textbf{Bestellnummer} & <?lsmb ordnumber ?>
\end{tabular}
