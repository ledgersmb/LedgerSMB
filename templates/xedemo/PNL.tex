...
\begin{longtable}{@{\extracolsep{'0pt}}<?lsmb i = 1; WHILE i <= max_path_depth ; 'l'; i = i + 1; END;
 -?>p{2cm}<?lsmb FOREACH c IN report.sorted_col_ids; 'r'; END ?>}
\\
...
<?lsmb FOREACH row IN report.sorted_row_ids ;
   IF report.rheads.ids.$row.props.section_for;
     ...
     IF report.rheads.ids.$row_id.props.account_category == 'Q';
       NEXT;
     END;
   END;
