...
\begin{tabular*}{\textwidth}{@{}lp{\descrwidth}@{\extracolsep\fill}rlrrr@{}}
  ...
  & Transport van <?lsmb lastpage ?> & & & & & <?lsmb sumcarriedforward ?> \\
<?lsmb end pagebreak ?>
...
\begin{tabular}[t]{l@{\hspace{0.3cm}}l}
  \textbf{Bestel Datum} & <?lsmb orddate ?> \\
<?lsmb if reqdate ?>
...
<?lsmb foreach tax ?>
  <?lsmb taxdescription ?> over <?lsmb taxbase ?> & <?lsmb tax ?>\\
<?lsmb end tax ?>
  \hline
  \textbf{Totaal} & \textbf{<?lsmb ordtotal ?>}\\
\end{tabularx}
