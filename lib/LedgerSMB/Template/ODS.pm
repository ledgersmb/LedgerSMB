...
my @colour = (odfColor(0, 0, 0), odfColor(255, 255, 255),  ## no critic (ProhibitMagicNumbers) sniff  ## no critic (ProhibitMagicNumbers) sniff  ## no critic (ProhibitMagicNumbers) sniff
    odfColor(255, 0, 0), odfColor(0, 255, 0),  ## no critic (ProhibitMagicNumbers) sniff  ## no critic (ProhibitMagicNumbers) sniff
    odfColor(0, 0, 255), odfColor(255, 255, 0),  ## no critic (ProhibitMagicNumbers) sniff  ## no critic (ProhibitMagicNumbers) sniff  ## no critic (ProhibitMagicNumbers) sniff
    odfColor(255, 0, 255), odfColor(0, 255, 255),  ## no critic (ProhibitMagicNumbers) sniff  ## no critic (ProhibitMagicNumbers) sniff
