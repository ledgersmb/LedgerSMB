...
my %screens = (
    ...
    'Create New Batch' => 'PageObject::App::Cash::Batches::Payments',
    ...
    'Filtering Payments' => 'PageObject::App::Cash::Batches::Payments::Filter',
    ...
    'Payments Detail' => 'PageObject::App::Cash::Batches::Payments::Detail',
