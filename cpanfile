...
requires 'Locale::CLDR::Locales::Ar::Any::Eg';
...
requires 'Locale::CLDR::Locales::De::Any::Ch';
requires 'Locale::CLDR::Locales::El';
requires 'Locale::CLDR::Locales::En';
requires 'Locale::CLDR::Locales::En::Any::Ca';
requires 'Locale::CLDR::Locales::En::Any::Gb';
requires 'Locale::CLDR::Locales::En::Any::Us';
requires 'Locale::CLDR::Locales::Es';
requires 'Locale::CLDR::Locales::Es::Any::Ar';
requires 'Locale::CLDR::Locales::Es::Any::Co';
requires 'Locale::CLDR::Locales::Es::Any::Ec';
requires 'Locale::CLDR::Locales::Es::Any::Mx';
requires 'Locale::CLDR::Locales::Es::Any::Pa';
requires 'Locale::CLDR::Locales::Es::Any::Py';
requires 'Locale::CLDR::Locales::Es::Any::Ve';
requires 'Locale::CLDR::Locales::Et';
requires 'Locale::CLDR::Locales::Fi';
requires 'Locale::CLDR::Locales::Fr';
requires 'Locale::CLDR::Locales::Fr::Any::Be';
requires 'Locale::CLDR::Locales::Fr::Any::Ca';
...
requires 'Locale::CLDR::Locales::Zh::Hans::Cn';
requires 'Locale::CLDR::Locales::Zh::Hant::Tw';
