...
INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1024, -1000, date1(), 1010, 'XTS', 1010, true, -111);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1024, -1001, date1(), -1000, 'XTS', -1000, true, -112);

INSERT INTO ac_tax_form(entry_id, reportable) values (-112, true);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1024, -1001, date1(), -10, 'XTS', -10, true, -113);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1024, -1002, date1(), 1010, 'XTS', 1010, true, -114);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1024, -1000, date1(), -1010, 'XTS', -1010, true, -115);
...
INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1025, -1001, date1(), -1000, 'XTS', -1000, true, -122);

INSERT INTO ac_tax_form(entry_id, reportable) values (-122, true);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1025, -1001, date1(), -10, 'XTS', -10, true, -123);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1025, -1002, date1(), 505, 'XTS', 505, true, -124);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1025, -1000, date1(), -505, 'XTS', 505, true, -125);
...
INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1026, -1000, date1(), 1010, 'XTS', 1010, true, -131);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1026, -1001, date1(), -1000, 'XTS', -1000, true, -132);

INSERT INTO ac_tax_form(entry_id, reportable) values (-132, true);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1026, -1001, date1(), -10, 'XTS', -10, true, -133);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1026, -1002, date1(), 505, 'XTS', 505, true, -134);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1026, -1000, date1(), -505, 'XTS', -505, true, -135);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1026, -1002, date2(), 505, 'XTS', 505, true, -136);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1026, -1000, date2(), -505, 'XTS', -505, true, -137);
...
INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1027, -1000, date1(), 1010, 'XTS', 1010, true, -141);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1027, -1001, date1(), -1000, 'XTS', -1000, true, -142);

INSERT INTO ac_tax_form(entry_id, reportable) values (-142, true);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1027, -1001, date1(), -10, 'XTS', -10, true, -143);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1027, -1002, date1(), 1010, 'XTS', -10, true, -144);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1027, -1000, date1(), -1010, 'XTS', -1010, true, -145);


-- 2) AP invoice: Reportable amount $1000, non-reportable amount $10,
-- partially paid ($500) in current year -1035

INSERT INTO ar (id, transdate, amount_bc, netamount_bc, curr, amount_tc, netamount_tc,
                entity_credit_account, approved, invoice, invnumber)
      values(-1035, date1(), 1010, 1010, 'XTS', 1010, 1010, -255, true, true, 'test1');

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1035, -1000, date1(), 1010, 'XTS', 1010, true, -221);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1035, -1001, date1(), -1000, 'XTS', -1000, true, -222);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1035, -1001, date1(), -10, 'XTS', -10, true, -223);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1035, -1002, date1(), 505, 'XTS', 505, true, -224);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1035, -1000, date1(), -505, 'XTS', 505, true, -225);
...
INSERT INTO ar (id, transdate, amount_bc, netamount_bc, curr, amount_tc, netamount_tc,
                entity_credit_account, approved, invoice, invnumber)
      values(-1036, date1(), 1010, 1010, 'XTS', 1010, 1010, -255, true, true, 'test2');

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1036, -1000, date1(), 1010, 'XTS', 1010, true, -231);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1036, -1001, date1(), -1000, 'XTS', -1000, true, -232);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1036, -1001, date1(), -10, 'XTS', -10, true, -233);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1036, -1002, date1(), 505, 'XTS', 505, true, -234);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1036, -1000, date1(), -505, 'XTS', -505, true, -235);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1036, -1002, date2(), 505, 'XTS', 505, true, -236);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1036, -1000, date2(), -505, 'XTS', -505, true, -237);
...
INSERT INTO ar (id, transdate, amount_bc, netamount_bc, curr, amount_tc, netamount_tc,
                entity_credit_account, approved, invoice, invnumber)
      values(-1037, date1(), 1010, 1010, 'XTS', 1010, 1010, -256, true, true, 'test3');

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1037, -1000, date1(), 1010, 'XTS', 1010, true, -241);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1037, -1001, date1(), -1000, 'XTS', -1000, true, -242);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1037, -1001, date1(), -10, 'XTS', -10, true, -243);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1037, -1002, date1(), 1010, 'XTS', 1010, true, -244);

INSERT INTO acc_trans(trans_id, chart_id, transdate, amount_bc, curr, amount_tc, approved, entry_id)
     VALUES (-1037, -1000, date1(), -1010, 'XTS', -1010, true, -245);
