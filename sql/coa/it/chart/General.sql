...
SELECT account_save(NULL,'7025025','Spese pubblicità/propaganda','E','', NULL, false,string_to_array('AP_amount', ':'));
...
SELECT account_save(NULL,'8041010','Spese di costituzione società','I','', NULL, false,string_to_array('AP_amount', ':'));
