...
SELECT account_save(NULL,'1520','Inventário / Geral','A','', NULL, false, false, string_to_array('IC', ':'));
SELECT account_save(NULL,'1530','Inventário / Mercado Secundário','A','', NULL, false, false, string_to_array('IC', ':'));
SELECT account_save(NULL,'1540','Inventário / Computer Parts','A','', NULL, false, false, string_to_array('IC', ':'));
SELECT account_heading_save(NULL, '1800', 'CAPITAL ASSETS', NULL);
SELECT account_save(NULL,'1820','Escritório Móvel & Equipamentos','A','', NULL, false, false, string_to_array('', ':'));
SELECT account_save(NULL,'1825','Accum. Amort. -Móvel. & Equip.','A','', NULL, true, false, string_to_array('', ':'));
SELECT account_save(NULL,'1840','Veículo','A','', NULL, false, false, string_to_array('', ':'));
SELECT account_save(NULL,'1845','Accum. Amort. -Veículo','A','', NULL, true, false, string_to_array('', ':'));
...
SELECT account_save(NULL,'2380','Contas a pagar de férias','L','', NULL, false, false, string_to_array('', ':'));
...
SELECT account_save(NULL,'2620','Empréstimo bancário','L','', NULL, false, false, string_to_array('', ':'));
SELECT account_save(NULL,'2680','Empréstimo de Acionistas','L','', NULL, false, false, string_to_array('AP_paid', ':'));
...
SELECT account_save(NULL,'4030','Partes para mercado secundário','I','', NULL, false, false, string_to_array('AR_amount:IC_sale', ':'));
...
SELECT account_save(NULL,'4450','Ganho de câmbio estrangeiro','I','', NULL, false, false, string_to_array('', ':'));
...
SELECT account_save(NULL,'5050','Mercado Secundário','E','', NULL, false, false, string_to_array('AP_amount:IC_cogs', ':'));
...
SELECT account_save(NULL,'5410','Salários','E','', NULL, false, false, string_to_array('', ':'));
...
SELECT account_save(NULL,'5615','Publicidade & Promoções','E','', NULL, false, false, string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'5620','Balanço','E','', NULL, false, false, string_to_array('', ':'));
SELECT account_save(NULL,'5660','Amortização','E','', NULL, false, false, string_to_array('', ':'));
...
SELECT account_save(NULL,'5690','Interesses & Encargos Bancários','E','', NULL, false, false, string_to_array('', ':'));
SELECT account_save(NULL,'5700','Materiais de Escritório','E','', NULL, false, false, string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'5760','Aluguel','E','', NULL, false, false, string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'5765','Manutenção & Reparos','E','', NULL, false, false, string_to_array('AP_amount', ':'));
...
SELECT account_save(NULL,'5790','Serviços Públicos','E','', NULL, false, false, string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'5800','Licenciamento para exportações','E','', NULL, false, false, string_to_array('AP_amount', ':'));
