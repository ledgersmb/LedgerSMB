...
SELECT account_save(NULL,'2280','Payroll Taxes Payable','L','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'2310','VAT (10%)','L','', NULL, false,string_to_array('AR_tax:AP_tax:IC_taxpart:IC_taxservice', ':'));
...
SELECT account_save(NULL,'4030','Sales / Aftermarket Parts','I','', NULL, false,string_to_array('AR_amount:IC_sale', ':'));
SELECT account_heading_save(NULL, '4300', 'CONSULTING REVENUE', NULL);
SELECT account_save(NULL,'4320','Consulting','I','', NULL, false,string_to_array('AR_amount:IC_income', ':'));
...
SELECT account_save(NULL,'5010','Purchases','E','', NULL, false,string_to_array('AP_amount:IC_expense', ':'));
...
SELECT account_save(NULL,'5680','Income Taxes','E','', NULL, false,string_to_array('', ':'));
