...
SELECT account_save(NULL,'4660','Visszaigényelhetõ ÁFA 25%','466','L', NULL, false,string_to_array('AP_tax:IC_taxpart:IC_taxservice', ':'));
...
SELECT account_save(NULL,'4670','Fizetendõ ÁFA 25%','467','L', NULL, false,string_to_array('AR_tax:IC_taxpart:IC_taxservice', ':'));
