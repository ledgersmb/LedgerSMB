...
SELECT account_save(NULL,'1140','Irodai eszközök','A','114', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'1199','Irodai eszközök ÉCS','A','119', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'2610','Áruk ','A','261', NULL, false,string_to_array('IC', ':'));
SELECT account_save(NULL,'3110','Vevõk','A','311', NULL, false,string_to_array('AR', ':'));
SELECT account_save(NULL,'3111','Külföldi vevõk','A','311', NULL, false,string_to_array('AR', ':'));
SELECT account_save(NULL,'3810','Pénztár 1','A','381', NULL, false,string_to_array('AR_paid:AP_paid', ':'));
SELECT account_save(NULL,'3811','Pénztár 2','A','381', NULL, false,string_to_array('AR_paid:AP_paid', ':'));
...
SELECT account_save(NULL,'4540','Belföldi Szállítók','L','454', NULL, false,string_to_array('AP', ':'));
SELECT account_save(NULL,'4541','Külföldi szállítók','L','454', NULL, false,string_to_array('AP', ':'));
SELECT account_save(NULL,'4660','Visszaigényelhetõ ÁFA 20%','L','466', NULL, false,string_to_array('AP_tax:IC_taxpart:IC_taxservice', ':'));
SELECT account_save(NULL,'4661','Visszaigényelhetõ ÁFA 12%','L','466', NULL, false,string_to_array('AP_tax:IC_taxpart:IC_taxservice', ':'));
SELECT account_save(NULL,'4662','Visszaigényelhetõ ÁFA 5%','L','466', NULL, false,string_to_array('AP_tax:IC_taxpart:IC_taxservice', ':'));
SELECT account_save(NULL,'4663','Visszaigényelhetõ ÁFA adómentes','L','466', NULL, false,string_to_array('AP_tax:IC_taxpart:IC_taxservice', ':'));
SELECT account_save(NULL,'4670','Fizetendõ ÁFA 20%','L','467', NULL, false,string_to_array('AR_tax:IC_taxpart:IC_taxservice', ':'));
SELECT account_save(NULL,'4671','Fizetendõ ÁFA 15%','L','467', NULL, false,string_to_array('AR_tax:IC_taxpart:IC_taxservice', ':'));
SELECT account_save(NULL,'4672','Fizetendõ ÁFA 5%','L','467', NULL, false,string_to_array('AR_tax:IC_taxpart:IC_taxservice', ':'));
SELECT account_save(NULL,'4673','Fizetendõ ÁFA adómentes','L','467', NULL, false,string_to_array('AR_tax:IC_taxpart:IC_taxservice', ':'));
SELECT account_save(NULL,'5200','Bérleti díj','E','520', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'5210','Telefon','E','521', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'5990','Költségek','E','599', NULL, false,string_to_array('IC_expense', ':'));
SELECT account_save(NULL,'8140','Eladott áruk beszerzési értéke','E','814', NULL, false,string_to_array('IC_cogs', ':'));
SELECT account_save(NULL,'8700','Árfolyamveszteség','E','870', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'9110','Belföldi árbevétel','I','911', NULL, false,string_to_array('AR_amount:IC_sale:IC_income', ':'));
SELECT account_save(NULL,'9111','Külföldi árbevétel','I','911', NULL, false,string_to_array('AR_amount:IC_sale:IC_income', ':'));
SELECT account_save(NULL,'9700','Árfolyamnyereség','I','970', NULL, false,string_to_array('', ':'));
--
