...
SELECT account_save(NULL,'201000','FRAIS D\'ETABLISSEMENT','E','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'209000','SORTIE D\'IMMOBILISATION','I','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'474100','DIVERS A REINTEGRER','I','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'474200','BENEFICE SCM','I','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'475000','PLUS VALUES A COURT TERME','I','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'530000','CAISSE','I','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'760000','PRODUITS FINANCIERS','I','', NULL, false,string_to_array('AR_amount', ':'));
SELECT account_save(NULL,'770000','PRODUITS EXCEPTIONNELS','I','', NULL, false,string_to_array('AR_amount', ':'));
SELECT account_save(NULL,'530010','CAISSE','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'607000','ACHATS DE MARCHANDISES','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'622700','FRAIS D\'ACTES ET DE CONTENTIEUX','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'438600','AUTRES CHARGES A PAYER','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'473000','DIVERS A DEDUIRE','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'613200','LOCATIONS IMMOBILIERES','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'616000','PRIMES D\'ASSURANCE','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'633800','AUTRES','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'695000','IMPOTS SUR LES BENEFICES','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'108100','COMPTE DE LEXPLOITANT','E','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'512030','EPARGNE','A','', NULL, false,string_to_array('AR_paid:AP_paid', ':'));
...
SELECT account_save(NULL,'108000','COMPTE DE LEXPLOITANT','I','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'200001','IMMOBILISATION','E','', NULL, false,string_to_array('', ':'));
...
SELECT account_save(NULL,'695100','IMPOTS DUS EN FRANCE','E','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'646000','COTIS. SOCIAL. PERSON. EXPLOITANT','E','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'645000','CHARGES DE SECUR. SOC. ET PREVOY.','E','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'617000','ETUDES ET RECHERCHES','E','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'615000','ENTRETIEN ET REPARATIONS','E','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'613500','LOCATIONS MOBILIERES','E','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'611000','SOUS-TRAITANCE GENERALE','E','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'695500','DEBOURS PAYES POUR LE COMPTE','E','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'690000','PARTICIP. SAL. / IMPOTS SUR BEN.','E','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'687600','DOTAT. AUX PROV. DEPREC. EXCEPT.','E','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'681000','DOTATIONS AUX AMORT. & AUX PROVIS.','E','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'628100','CONCOURS DIVERS (COTISATIONS,...)','E','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'625600','MISSIONS','E','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'645800','COTISATIONS AUX AUTRES ORG. SOC.','E','', NULL, false,string_to_array('AP_amount', ':'));
...
SELECT account_save(NULL,'706000','PRESTATIONS DE SERVICES','I','', NULL, false,string_to_array('IC_income', ':'));
SELECT account_save(NULL,'707000','VENTES DE MARCHANDISES','I','', NULL, false,string_to_array('IC_sale', ':'));
SELECT account_save(NULL,'445713','TVA COLLECTEE 19.6%','I','', NULL, false,string_to_array('AR_tax:IC_taxpart:IC_taxservice', ':'));
...
SELECT account_save(NULL,'766000','GAINS DE CHANGE','I','', NULL, false,string_to_array('AR_amount:IC_income', ':'));
SELECT account_save(NULL,'472000','MOINS VALUES A COURT TERME','E','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'474000','DEFICIT SCM','E','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'670000','CHARGES FINANCIERES','E','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'645100','COTISATIONS A L\'URSSAF','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'645200','COTISATIONS AUX MUTUELES','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'645300','COTISATIONS AUX CAISSES RETR.','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'646400','COTISATIONS AUX ASSEDIC','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'623400','CADEAUX A LA CLIENTELE','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'437000','AUTRES ORGANISMES SOCIAUX','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'606100','FOURNITURES NON STOCK. EAU ENERG.','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'606300','FOURNIT. ENTRETIEN & PETIT EQUIP.','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'625010','DEPLACEMENTS AUTO','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'635110','TAXE PROFESSIONNELLE','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'645001','CSG','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'660000','CHARGES FINANCIERES','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'666000','PERTES DE CHANGE','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'512040','EXPLOITANT','E','', NULL, false,string_to_array('AP_paid', ':'));
SELECT account_save(NULL,'431000','SECURITE SOCIALE','E','', NULL, false,string_to_array('', ':'));
INSERT INTO chart (accno, description, charttype, gifi_accno, category, link) VALUES ('609400', 'D\'ETUDES & PRESTATIONS DE SERVICES', 'A', '', '', '');
SELECT account_save(NULL,'625100','VOYAGES ET DEPLACEMENTS','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'618300','DOCUMENTATION TECHNIQUE','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'445663','TVA DEDUCTIBLE 19.6%','E','', NULL, false,string_to_array('AP_tax:IC_taxpart:IC_taxservice', ':'));
SELECT account_save(NULL,'601000','ACHATS STOCKES MAT. PREM. (FOURN.)','E','', NULL, false,string_to_array('AP_amount:IC_cogs', ':'));
SELECT account_save(NULL,'626000','FRAIS POSTAUX ET TELECOMMUNIC.','E','', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'512000','BANQUE','A','', NULL, false,string_to_array('AR_paid:AP_paid', ':'));
--
SELECT account_save(NULL,'999000','Foreign Exchange Gain','I','', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'999010','Foreign Exchange Loss','E','', NULL, false,string_to_array('', ':'));
--
-- insert taxes
--
