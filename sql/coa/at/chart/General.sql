...
SELECT account_save(NULL,'0210','unbebaute Grundstücke','A','020', NULL, false, false, string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'0220','bebaute Grundstücke','A','021', NULL, false, false, string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'0229','kum. Abschreibung bebaute Grundstücke','A','039', NULL, true, false, string_to_array('', ':'));
...
SELECT account_save(NULL,'0620','Büroeinrichtungen','A','066', NULL, false, false, string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'0625','kum. Abschreibung Betriebs- und Geschäftsausstattung','A','069', NULL, true, false, string_to_array('', ':'));
...
SELECT account_save(NULL,'1120','Vorräte - Rohstoffe','A','110-119', NULL, false, false, string_to_array('IC', ':'));
SELECT account_heading_save(NULL, '1200', 'BEZOGENE TEILE', NULL);
SELECT account_save(NULL,'1220','Vorräte - bezogene Teile','A','120-129', NULL, false, false, string_to_array('IC', ':'));
...
SELECT account_save(NULL,'1420','Vorräte - unfertige Erzeugnisse','A','140-149', NULL, false, false, string_to_array('IC', ':'));
SELECT account_heading_save(NULL, '1500', 'FERTIGE ERZEUGNISSE', NULL);
SELECT account_save(NULL,'1520','Vorräte - Hardware','A','150-159', NULL, false, false, string_to_array('IC', ':'));
SELECT account_save(NULL,'1530','Vorräte - Software','A','150-159', NULL, false, false, string_to_array('IC', ':'));
SELECT account_save(NULL,'1540','Vorräte - Ersatzteile','A','150-159', NULL, false, false, string_to_array('IC', ':'));
...
SELECT account_save(NULL,'2620','Wertpapiere Umlaufvermögen','A','26', NULL, false, false, string_to_array('AP_amount', ':'));
...
SELECT account_save(NULL,'3120','Kredite von Eigentümern','L','310', NULL, false, false, string_to_array('AP_paid', ':'));
...
SELECT account_save(NULL,'3510','Finanzamt Verrechnung Körperschaftssteuer','L','350-359', NULL, false, false, string_to_array('', ':'));
...
SELECT account_save(NULL,'4320','Erlöse Beratung','I','40-44', NULL, false, false, string_to_array('AR_amount:IC_income', ':'));
SELECT account_save(NULL,'4330','Erlöse Programmierung','I','40-44', NULL, false, false, string_to_array('AR_amount:IC_income', ':'));
SELECT account_heading_save(NULL, '4600', 'SONSTIGE ERLÖSE', NULL);
SELECT account_save(NULL,'4630','Frachterlöse','I','46-49', NULL, false, false, string_to_array('IC_income', ':'));
...
SELECT account_save(NULL,'7020','geringwertige Wirtschaftsgüter','E','701-708', NULL, false, false, string_to_array('AP_amount', ':'));
...
SELECT account_save(NULL,'7611','Büromaterialien','E','760', NULL, false, false, string_to_array('AP_amount', ':'));
...
SELECT account_save(NULL,'7632','Reise- und Repräsentationsaufwand','E','734-735', NULL, false, false, string_to_array('', ':'));
SELECT account_save(NULL,'7634','Registrierungsgebühren','E','748-749', NULL, false, false, string_to_array('AP_amount', ':'));
...
SELECT account_save(NULL,'8020','Bankzinsen und Gebühren','E','80-83', NULL, false, false, string_to_array('', ':'));
SELECT account_heading_save(NULL, '8100', 'BETEILIGUNGSERTRÄGE', NULL);
SELECT account_save(NULL,'8110','Erträge aus Beteiligungen','I','800-804', NULL, false, false, string_to_array('', ':'));
SELECT account_heading_save(NULL, '9000', 'KAPITAL', NULL);
SELECT account_save(NULL,'9010','Aktien, Geschäftsanteile','Q','900-918', NULL, false, false, string_to_array('', ':'));
...
SELECT account_save(NULL,'9210','freie Rücklage','Q','920-929', NULL, false, false, string_to_array('', ':'));
...
SELECT account_save(NULL,'9420','Abfertigungsrückstellung','L','300', NULL, false, false, string_to_array('', ':'));
SELECT account_save(NULL,'9430','Urlaubsrückstellung','L','304-309', NULL, false, false, string_to_array('', ':'));
