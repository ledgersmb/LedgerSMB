...
SELECT account_save(NULL,'0229','kum. Abschreibung bebaute Grundstücke','A','039', NULL, true,string_to_array('', ':'));
...
SELECT account_save(NULL,'0625','kum. Abschreibung Betriebs- und Geschäftsausstattung','A','069', NULL, true,string_to_array('', ':'));
