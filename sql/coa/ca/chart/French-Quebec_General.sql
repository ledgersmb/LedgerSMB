...
SELECT account_save(NULL,'1060','Compte chèque','A','1002', NULL, false,string_to_array('AR_paid:AP_paid', ':'));
...
SELECT account_save(NULL,'1205','Provisions pour créances douteuses','A','1063', NULL, false,string_to_array('', ':'));
SELECT account_heading_save(NULL, '1500', 'INVENTAIRE', NULL);
SELECT account_save(NULL,'1520','Inventaire / Général','A','1122', NULL, false,string_to_array('IC', ':'));
SELECT account_save(NULL,'1530','Inventaire / Pièces de rechange','A','1122', NULL, false,string_to_array('IC', ':'));
SELECT account_save(NULL,'1540','Inventaire / Matières premières','A','1122', NULL, false,string_to_array('IC', ':'));
...
SELECT account_save(NULL,'1840','Véhicules automobiles','A','1742', NULL, false,string_to_array('', ':'));
...
SELECT account_save(NULL,'2160','Taxes fédérales à payer','L','2683', NULL, false,string_to_array('', ':'));
...
SELECT account_save(NULL,'2380','Indemnités de vacances à payer','L','2624', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'2390','CSST à payer','L','2627', NULL, false,string_to_array('', ':'));
...
SELECT account_save(NULL,'2420','RRQ à payer','L','2627', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'2450','Impôt sur le revenu à payer','L','2628', NULL, false,string_to_array('', ':'));
...
SELECT account_save(NULL,'2680','Emprunt auprès des actionnaires','L','2780', NULL, false,string_to_array('AP_paid', ':'));
...
SELECT account_save(NULL,'4020','Ventes générales','I','8000', NULL, false,string_to_array('AR_amount:IC_sale:IC_income', ':'));
SELECT account_save(NULL,'4030','Pièces de rechange','I','8000', NULL, false,string_to_array('AR_amount:IC_sale', ':'));
...
SELECT account_save(NULL,'4440','Intérêts','I','8090', NULL, false,string_to_array('IC_income', ':'));
...
SELECT account_save(NULL,'5050','Pièces de rechange','E','8320', NULL, false,string_to_array('AP_amount:IC_cogs', ':'));
...
SELECT account_save(NULL,'5420','Dépenses d''assurance-emploi','E','8622', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'5430','Dépenses RRQ','E','8622', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'5440','Dépenses CSST','E','8622', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'5450','Dépenses FSS','E','8622', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'5460','Dépenses RQAP','E','8622', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'5470','Dépenses vacances','E','8622', NULL, false,string_to_array('', ':'));
SELECT account_heading_save(NULL, '5600', 'DÉPENSES ADMINISTRATIVES ET GÉNÉRALES', NULL);
SELECT account_save(NULL,'5610','Frais comptables et juridiques','E','8862', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'5615','Publicité et promotion','E','8520', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'5620','Créances irrévocables','E','8590', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'5660','Amortissement de l''exercice','E','8670', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'5680','Impôt sur le revenu','E','9990', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'5685','Assurances','E','9804', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'5690','Intérêts et frais bancaires','E','9805', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'5700','Fournitures de bureau','E','8811', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'5760','Loyer','E','9811', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'5780','Téléphone','E','9225', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'5785','Voyages et loisirs','E','8523', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'5790','Services publics','E','8812', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'5765','Réparation et entretien','E','8964', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'5800','Taxes d''affaires, droits d''adhésion et permis','E','8760', NULL, false,string_to_array('AP_amount', ':'));
SELECT account_save(NULL,'5810','Perte sur change','E','8231', NULL, false,string_to_array('', ':'));
--
