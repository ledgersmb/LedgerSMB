...
SELECT account_save(NULL,'18002','Accumulated Amortization -Land & Buildings','A','180', NULL, true,string_to_array('','1', ':'));
SELECT account_save(NULL,'18003','Office Furniture & Equipment','A','180', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'18004','Accumulated Amortization -Furniture & Equipment','A','180', NULL, true,string_to_array('','1', ':'));
SELECT account_save(NULL,'18005','Vehicle','A','180', NULL, false,string_to_array('', ':'));
SELECT account_save(NULL,'18006','Accumulated Amortization -Vehicle','A','180', NULL, true,string_to_array('','1', ':'));
