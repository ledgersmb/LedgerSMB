...
CREATE TABLE payroll_wage (
   entry_id integer generated by default AS IDENTITY not null unique,
...
CREATE TABLE note_class(id integer generated by default AS IDENTITY primary key, class text not null check (class ~ '[[:alnum:]_]'));
...
CREATE TABLE note (id integer generated by default AS IDENTITY primary key,
...
CREATE TABLE inventory_report (
   id integer generated by default AS IDENTITY primary key, -- these are not tied to external sources usually
...
CREATE TABLE taxmodule (
  taxmodule_id integer generated by default AS IDENTITY PRIMARY KEY,
...
CREATE TABLE taxcategory (
  taxcategory_id integer generated by default AS IDENTITY PRIMARY KEY,
...
CREATE TABLE asset_item (
        id integer generated by default AS IDENTITY primary key, -- needed due to possible null in natural key
        description text,
        tag text not null,
