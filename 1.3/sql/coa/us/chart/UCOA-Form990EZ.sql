...
SELECT account_save(NULL,'1115','Doubtful accounts allowance','A','24', NULL, true, false, string_to_array('AR_paid', ':'));
...
SELECT account_save(NULL,'1215','Doubtful pledges allowance','A','24', NULL, true, false, string_to_array('AR_paid', ':'));
SELECT account_save(NULL,'1225','Discounts - long-term pledges','A','24', NULL, true, false, string_to_array('AR_paid', ':'));
SELECT account_save(NULL,'1240','Grants receivable','A','24', NULL, false, false, string_to_array('AR', ':'));
SELECT account_save(NULL,'1245','Discounts - long-term grants','A','24', NULL, true, false, string_to_array('AR_paid', ':'));
...
SELECT account_save(NULL,'1325','Doubtful notes/loans allowance','A','24', NULL, true, false, string_to_array('AR_paid', ':'));
...
SELECT account_save(NULL,'1545','Accum deprec - bldg investment','A','22', NULL, true, false, string_to_array('', ':'));
...
SELECT account_save(NULL,'1725','Accum deprec - building','A','23', NULL, true, false, string_to_array('', ':'));
SELECT account_save(NULL,'1735','Accum amort - leasehold improvements','A','24', NULL, true, false, string_to_array('', ':'));
SELECT account_save(NULL,'1745','Accum deprec - furn,fix,equip','A','24', NULL, true, false, string_to_array('', ':'));
SELECT account_save(NULL,'1755','Accum deprec - vehicles','A','24', NULL, true, false, string_to_array('', ':'));
...
SELECT account_save(NULL,'4075','Uncollectible pledges - estimated','I','1', NULL, true, false, string_to_array('', ':'));
SELECT account_save(NULL,'4085','Long-term pledges discount','I','1', NULL, true, false, string_to_array('', ':'));
...
SELECT account_save(NULL,'4255','Discounts - long-term grants','I','1', NULL, true, false, string_to_array('', ':'));
...
SELECT account_save(NULL,'5355','Personal property rental cost','I','8', NULL, true, false, string_to_array('', ':'));
...
SELECT account_save(NULL,'5375','Securities sales cost ','I','5b', NULL, true, false, string_to_array('', ':'));
...
SELECT account_save(NULL,'5415','Non-inventory sales cost ','I','5b', NULL, true, false, string_to_array('', ':'));
SELECT account_save(NULL,'5440','Gross sales - inventory','I','8', NULL, false, false, string_to_array('AR_amount:IC_sale', ':'));
SELECT account_save(NULL,'5445','Cost of inventory sold ','I','8', NULL, true, false, string_to_array('', ':'));
