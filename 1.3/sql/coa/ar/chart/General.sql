...
SELECT account_save(NULL, '2.1.2.03','Ganancia Mi­nima Presunta (1%)','L','', (SELECT id FROM account WHERE accno LIKE '2.1.2.'), false, true, string_to_array('IC_taxservice:IC_taxpart:AR_tax', ':'));
