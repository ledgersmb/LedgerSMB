// This class is copied verbatim from dijit/Tree
// with the notable excetion that it doesn't set the
// 'state' property directly, but rather through "this.set('state',...)"
// which means that the CSS mixin can actually monitor the property changes
// meaning that the state gets applied as CSS class immediately
// instead of on 'mouseover' as per dijit/Tree's behaviour.
define([
        ...
        "dijit/a11yclick",
        "dijit/focus",
        "dijit/registry", // registry.byNode(), registry.getEnclosingWidget()
        ...
        "dijit/_KeyNavMixin",
        "dojo/text!dijit/templates/TreeNode.html",
        "dojo/text!dijit/templates/Tree.html",
