                ...
                lang.hitch(this, function (child, index) {
                    ...
                    if (colspan > 1) {
                        colspan = this.showLabels
                            ? Math.min(maxCols - 1, colspan * 2 - 1)
                            : Math.min(maxCols, colspan);
                    }

                    // Create a new row if we need one
                    if (
                        numCols + colspan - 1 + (this.showLabels ? 1 : 0) >=
                        maxCols
                    ) {
                        numCols = 0;
                    ...
                    if (this.showLabels) {
                        ...
                        if (child.spanLabel) {
                            ...
                            label.innerHTML =
                                child.get("label") || child.get("title");
                        }
                    }
                    var childCell;
