            ...
            return declare("lsmb/ComparisonSelectionIncome", ContentPane, {
                ...
                _toggles: function(ids,l) {
                    for ( var i = 1 ; i <= 9 ; i++ ) {
                        ...
                        registry.byId("from_date_" + i).set("disabled",!state);
                ...
                update: function(targetValue) {
                    ...
                    if ( targetValue === "by_dates"   ) {
                        ...
                        this._show("comparison_dates_to");
                        registry.byId("to_date").set("required",true);
                        ...
                        this._hide("comparison_dates_to");
                        registry.byId("to_date").set("required",false);
                        registry.byId("to_date").set("disabled",true);
