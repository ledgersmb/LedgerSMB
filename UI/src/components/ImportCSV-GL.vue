        ...
        <template v-slot:default>
           ...
           <dl>
             ...
             <dd>The debit amount to be posted on the line, in the functional (or
                 "native") currency; note that a single line can be
             ...
             <dd>The currency to be used for the transaction; if the transaction
                 does not concern foreign currencies, fill out the default
                 currency of the company</dd>

             <dt>debit_fx</dt>
             <dd>The foreign currency (transaction currency) debit amount in case
                 of a foreign currency transaction; in case the default currency
                 applies, fill with the same amount as the <code>debit</code>
                 field</dd>

             <dt>credit_fx</dt>
             <dd>The foreign currency (transaction currency) credit amount in case
                 of a foreign currency transaction; in case the default currency
                 applies, fill with the same amount as the credit field</dd>

             <dt>source</dt>
             <dd>The identifier of the transaction(line) in an external system;
