...
(function(e, m) {
  var k, n = function() {
    ...
    return f(t[a]) ? t[a] = t[a](p, s, w) : t[a]
  }, t = v.cache = m.hasCache;
  ...
  var E = 0, X = function(a) {
    ...
    for(var r in b) {
      ...
      b[r] !== t && (q.rawConfig[r] = b[r], "has" != r && v.add("config-" + r, b[r], 0, l))
    }
    q.baseUrl || (q.baseUrl = "./");
  ...
  var da = function(g) {
    ...
    if(b(a)) {
      if(a.length) {
        c = "require*" + u();
        for(var p, t = [], e = 0;e < a.length;) {
          p = a[e++], t.push(Z(p, d))
        }
        f = g(ea("", c, 0, ""), {injected:2, deps:t, def:l || n, require:d ? d.require : q, gc:1});
        G[f.mid] = f;
        da(f);
        var s = aa && 0 != "sync";
        la(function() {
    ...
    b && (q = oa(b.mid, u));
    (q = (q = q || u.star) && oa(g, q[1])) && (g = q[1] + g.substring(q[3]));
    b = ($ = g.match(/^([^\/]+)(\/(.+))?$/)) ? $[1] : "";
    (t = l[b]) ? g = b + "/" + (e = $[3] || t.main) : b = "";
    var w = 0;
    a(v, function(a) {
      var b = g.match(a[0]);
    ...
    if(w) {
      return Aa(w, 0, l, c, d, u, h, v, p)
    }
    if(l = c[g]) {
      return p ? ea(l.pid, l.mid, l.pack, l.url) : c[g]
    }
    c = (q = oa(g, h)) ? q[1] + g.substring(q[3]) : b ? t.location + "/" + e : g;
    /(^\/)|(\:)/.test(c) || (c = d + c);
    return ea(b, g, t, za(c + ".js"))
  }, ba = function(a, g, b) {
...
require({cache:{"dojo/request/xhr":function() {
  define(["../errors/RequestError", "./watch", "./handlers", "./util", "../has"], function(e, m, k, n, c) {
    ...
    function h(p, v, t) {
      ...
      try {
        D.open(L, p, K, v.user || u, v.password || u);
    ...
    var u, q = {data:null, query:null, sync:!1, method:"GET"};
    h._create = function() {
  ...
  define(["./sniff", "./_base/window", "./dom", "./dom-style"], function(e, m, k, n) {
    ...
    h.setMarginBox = function(a, g, r) {
      ...
      r = g.w;
      var u = g.h, q = f(a) ? b : h.getPadBorderExtents(a, l), l = h.getMarginExtents(a, l);
      if(e("webkit") && d(a)) {
        var p = a.style;
        0 <= r && !p.width && (p.width = "4px");
        0 <= u && !p.height && (p.height = "4px")
      }
      0 <= r && (r = Math.max(r - q.w - l.w, 0));
      0 <= u && (u = Math.max(u - q.h - l.h, 0));
      c(a, g.l, g.t, r, u)
    };
    ...
    return f.place = {at:function(a, g, c, l, d) {
      ...
      if("string" == typeof b || "offsetWidth" in b || "ownerSVGElement" in b) {
        if(p = m.position(b, !0), /^(above|below)/.test(c[0])) {
          var s = m.getBorderExtents(b), w = b.firstChild ? m.getBorderExtents(b.firstChild) : {t:0, l:0, b:0, r:0}, v = m.getBorderExtents(a), t = a.firstChild ? m.getBorderExtents(a.firstChild) : {t:0, l:0, b:0, r:0};
          p.y += Math.min(s.t + w.t, v.t + t.t);
          p.h -= Math.min(s.t + w.t, v.t + t.t) + Math.min(s.b + w.b, v.b + t.b)
        }
      }else {
        p = b
      }
      if(b.parentNode) {
        ...
        for(b = b.parentNode;b && 1 == b.nodeType && "BODY" != b.nodeName;) {
          ...
          if(!s && /hidden|auto|scroll/.test(v.overflow)) {
            var t = Math.min(p.y + p.h, w.y + w.h), x = Math.min(p.x + p.w, w.x + w.w);
  ...
  define("dojo/_base/declare dojo/_base/Deferred dojo/dom dojo/dom-attr dojo/dom-class dojo/dom-geometry dojo/dom-style dojo/has dojo/keys dojo/_base/lang dojo/on dojo/touch ./registry ./focus ./popup ./_FocusMixin".split(" "), function(e, m, k, n, c, d, f, h, b, a, g, r, l, u, q, p) {
  ...
  define("dojo/_base/array dojo/_base/declare dojo/dom dojo/dom-attr dojo/dom-class dojo/_base/lang dojo/mouse dojo/on dojo/window ./a11yclick ./registry ./_Widget ./_CssStateMixin ./_KeyNavContainer ./_TemplatedMixin".split(" "), function(e, m, k, n, c, d, f, h, b, a, g, r, l, u, q) {
    return m("dijit._MenuBase", [r, q, u, l], {selected:null, _setSelectedAttr:function(a) {
  ...
  define("exports ./_base/kernel ./sniff ./_base/lang ./dom ./dom-style ./dom-construct ./_base/connect".split(" "), function(e, m, k, n, c, d, f, h) {
    ...
    e.set = function(b, u, q) {
      b = c.byId(b);
      if(2 == arguments.length && "string" != typeof u) {
        for(var p in u) {
          e.set(b, p, u[p])
        }
        return b
  ...
  define("./kernel ./sniff require ../io-query ../dom ../dom-form ./Deferred ./config ./json ./lang ./array ../on ../aspect ../request/watch ../request/xhr ../request/util".split(" "), function(e, m, k, n, c, d, f, h, b, a, g, r, l, u, q, p) {
    e._xhrObj = q._create;
    var s = e.config;
    ...
    e._ioSetArgs = function(b, g, l, h) {
      ...
      if(b.form) {
        var v = c.byId(b.form), u = v.getAttributeNode("action");
        r.url = r.url || (u ? u.value : null);
        v = d.toObject(v)
      }
      u = [{}];
      v && u.push(v);
      b.content && u.push(b.content);
      b.preventCache && u.push({"dojo.preventCache":(new Date).valueOf()});
      r.query = n.objectToQuery(a.mixin.apply(null, u));
      r.handleAs = b.handleAs || "text";
      var k = new f(function(a) {
        a.canceled = !0;
        g && g(a);
      ...
      k.addCallback(l);
      var t = b.load;
      t && a.isFunction(t) && k.addCallback(function(a) {
        return t.call(b, a, r)
      });
      var q = b.error;
      q && a.isFunction(q) && k.addErrback(function(a) {
        return q.call(b, a, r)
      });
      var p = b.handle;
      p && a.isFunction(p) && k.addBoth(function(a) {
        return p.call(b, a, r)
      });
      k.addErrback(function(a) {
        return h(a, k)
      });
      s.ioPublish && (e.publish && !1 !== r.args.ioPublish) && (k.addCallbacks(function(a) {
        e.publish("/dojo/io/load", [k, a]);
        return a
      }, function(a) {
        e.publish("/dojo/io/error", [k, a]);
        return a
      }), k.addBoth(function(a) {
        e.publish("/dojo/io/done", [k, a]);
        return a
      }));
      k.ioArgs = r;
      return k
    ...
    l.after(u, "_onAction", function() {
      z -= 1
    });
    l.after(u, "_onInFlight", x);
    e._ioCancelAll = u.cancelAll;
  ...
  define("dojo/aspect dojo/_base/declare dojo/dom dojo/dom-attr dojo/dom-class dojo/dom-construct dojo/Evented dojo/_base/lang dojo/on dojo/domReady dojo/sniff dojo/Stateful dojo/_base/window dojo/window ./a11y ./registry ./main".split(" "), function(e, m, k, n, c, d, f, h, b, a, g, r, l, u, q, p, s) {
    var w, v, t = new (m([r, f], {curNode:null, activeStack:[], constructor:function() {
        ...
        for(;a;) {
          ...
          if(d) {
            ...
            if(a.tagName && "body" == a.tagName.toLowerCase()) {
              ...
              a = u.get(a.ownerDocument).frameElement
            }else {
    ...
    a(function() {
      var a = t.registerWin(u.get(document));
    ...
    for(var x in t) {
      /^_/.test(x) || (s.focus[x] = "function" == typeof t[x] ? h.hitch(t, x) : t[x])
    }
    t.watch(function(a, b, g) {
      s.focus[a] = g
    });
    return t
  })
  ...
  define("./_base/kernel require ./has ./_base/array ./_base/config ./_base/lang ./_base/xhr ./json module".split(" "), function(e, m, k, n, c, d, f, h, b) {
    ...
    var a = /(^.*(^|\/)nls)(\/|$)([^\/]*)\/?([^\/]*)/, g = function(a, b, g, c) {
    ...
    }, u = e.getL10nName = function(a, g, c) {
      return b.id + "!" + l(a, g, c)
    }, q = function(a, b, c, l, f, h) {
      a([b], function(e) {
        var v = d.clone(e.root || e.ROOT), k = g(!e._v1x && e, f, c, l);
        a(k, function() {
          for(var a = 1;a < k.length;a++) {
            v = d.mixin(d.clone(v), arguments[a])
          }
          r[b + "/" + f] = v;
          v.$locale = k.specificity;
          h()
        })
      })
    }, p = function(a) {
      ...
      b = a.exec(b);
      var v = b[1] + "/", u = b[5] || b[4], s = v + u, l = (b = b[5] && b[4]) || e.locale || "", w = s + "/" + l;
      b = b ? [l] : p(l);
    ...
    }, t = 0, x = [], z = f._preloadLocalizations = function(a, b, g, c) {
      function l(a, b) {
        c([a], b)
      }
      function f(a, b) {
            ...
            l(v, function(a) {
              for(var b in a) {
                ...
                if(v) {
                  ...
                  var u;
                  if("ROOT" === e) {
                    var n = u = l._localized;
                    delete l._localized;
                    n.root = l;
                    r[m.toAbsMid(b)] = n
                  }else {
                    u = l._localized, r[m.toAbsMid(v + k + "/" + e)] = l
                  }
                  e !== g && function(a, b, l, e) {
                    var v = [], k = [];
                    f(g, function(g) {
                      e[g] && (v.push(m.toAbsMid(a + g + "/" + b)), k.push(m.toAbsMid(a + b + "/" + g)))
                    });
                    v.length ? (t++, c(v, function() {
  ...
  define("require ./_base/kernel ./_base/lang ./_base/array ./_base/config ./dom ./_base/window ./_base/url ./aspect ./promise/all ./date/stamp ./Deferred ./has ./query ./on ./ready".split(" "), function(e, m, k, n, c, d, f, h, b, a, g, r, l, u, q, p) {
    function s(a) {
      return eval("(" + a + ")")
    }
    function w(a) {
    ...
    function v(a, b) {
      ...
      if(!x[g]) {
        ...
        l = c.shift();
        x[g] = c.length ? l.createSubclass ? l.createSubclass(c) : l.extend.apply(l, c) : l
      }
      return x[g]
    }
    new Date("X");
    ...
    var x = {}, z = {_clearCache:function() {
      ...
      var g = "", c = "", l = a.getAttribute(b + "args") || a.getAttribute("args"), d = a.getAttribute("with"), l = (l || "").split(/\s*,\s*/);
      d && d.length && n.forEach(d.split(/\s*,\s*/), function(a) {
        g += "with(" + a + "){";
        c += "}"
      });
      return new Function(l, g + a.innerHTML + c)
    }, instantiate:function(a, b, g) {
      b = b || {};
      g = g || {};
      var c = (g.scope || m._scopeName) + "Type", l = "data-" + (g.scope || m._scopeName) + "-", d = l + "type", f = l + "mixins", h = [];
      n.forEach(a, function(a) {
        var g = c in b ? b[c] : a.getAttribute(d) || a.getAttribute(c);
        if(g) {
          var l = a.getAttribute(f), g = l ? [g].concat(l.split(/\s*,\s*/)) : [g];
          h.push({node:a, types:g})
        }
      });
      return this._instantiate(h, b, g)
    }, _instantiate:function(b, g, c, l) {
      function d(a) {
            ...
            if(O in t || (O = w(a)[I] || O), O in t) {
              switch(typeof t[O]) {
                ...
                case "function":
                  ...
                  break;
                default:
                  I = t[O], p[O] = I && "length" in I ? E ? E.split(/\s*,\s*/) : [] : I instanceof Date ? "" == E ? new Date("") : "now" == E ? new Date : g.fromISOString(E) : I instanceof h ? m.baseUrl + E : s(E)
              }
            }else {
              p[O] = E
            }
      ...
      k.mixin(p, d);
      e || (e = a && (a._noScript || t._noScript) ? [] : u("\x3e script[type^\x3d'dojo/']", c));
      var R = [], H = [], Q = [], S = [];
      if(e) {
      ...
      a = (e = a.markupFactory || t.markupFactory) ? e(p, c, a) : new a(p, c);
      return a.then ? a.then(v) : v(a)
    }, scan:function(a, b) {
      function g(a) {
        if(!a.inherited) {
          a.inherited = {};
          var b = a.node, c = g(a.parent), b = {dir:b.getAttribute("dir") || c.dir, lang:b.getAttribute("lang") || c.lang, textDir:b.getAttribute(u) || c.textDir}, l;
          for(l in b) {
      ...
      var c = [], l = [], d = {}, f = (b.scope || m._scopeName) + "Type", h = "data-" + (b.scope || m._scopeName) + "-", k = h + "type", u = h + "textdir", h = h + "mixins", t = a.firstChild, p = b.inherited;
      if(!p) {
        var q = function(a, b) {
          return a.getAttribute && a.getAttribute(b) || a.parentNode && q(a.parentNode, b)
        }, p = {dir:q(a, "dir"), lang:q(a, "lang"), textDir:q(a, u)}, s;
        for(s in p) {
          p[s] || delete p[s]
        }
      }
      for(var p = {inherited:p}, w, z;;) {
        if(t) {
          if(1 != t.nodeType) {
            ...
            if(w && "script" == t.nodeName.toLowerCase()) {
              (x = t.getAttribute("type")) && /^dojo\/\w/i.test(x) && w.push(t), t = t.nextSibling
            }else {
              if(z) {
                t = t.nextSibling
              }else {
                var x = t.getAttribute(k) || t.getAttribute(f);
                s = t.firstChild;
                if(!x && (!s || 3 == s.nodeType && !s.nextSibling)) {
                  ...
                  if(x) {
                    ...
                    p = {types:w, ctor:z, parent:p, node:t, scripts:I};
                    p.inherited = g(p);
                    c.push(p)
                  }else {
                    p = {node:t, scripts:w, parent:p}
                  }
                  w = I;
                  z = t.stopParser || z && z.prototype.stopParser && !b.template;
                  t = s
                }
              }
            }
      ...
      var g = s("{" + a.innerHTML + "}"), c = [], l = [], d = new r, f = b && b.contextRequire || e, h;
      for(h in g) {
        c.push(h), l.push(g[h])
      }
      f(l, function() {
      ...
      g.resolve(!0);
      var l = this;
      u("script[type\x3d'dojo/require']", a).forEach(function(a) {
        c = c.then(function() {
  ...
  define(["./kernel", "./lang", "../sniff"], function(e, m, k) {
    var n = {global:e.global, doc:e.global.document || null, body:function(c) {
      ...
      var b = n.doc, a = k("quirks"), g = k("ie"), r, l, u;
      try {
        e.doc = n.doc = c;
        e.isQuirks = k.add("quirks", "BackCompat" == e.doc.compatMode, !0, !0);
        if(k("ie") && (u = c.parentWindow) && u.navigator) {
          r = parseFloat(u.navigator.appVersion.split("MSIE ")[1]) || void 0, (l = c.documentMode) && (5 != l && Math.floor(r) != l) && (r = l), e.isIE = k.add("ie", r, !0, !0)
        }
  ...
  define("./_base/kernel ./query ./_base/array ./_base/lang ./dom-class ./dom-construct ./dom-geometry ./dom-attr ./dom-style".split(" "), function(e, m, k, n, c, d, f, h, b) {
    ...
    var g = function(a) {
      ...
      var b = a.parentNode;
      b && b.removeChild(a)
    }, l = m.NodeList, u = l._adaptWithCondition, q = l._adaptAsForEach, p = l._adaptAsMap;
    n.extend(l, {_normalize:function(a, b) {
      ...
      if(!(1 != b.nodeType && "only" == c)) {
        for(var l, f = a.length, h = f - 1;0 <= h;h--) {
          var k = g ? this._cloneNode(a[h]) : a[h];
          ...
          h == f - 1 ? d.place(k, b, c) : b.parentNode.insertBefore(k, b);
          b = k
        }
      }
    }, position:p(f.position), attr:u(a(h), g), style:u(a(b), g), addClass:q(c.add), removeClass:q(c.remove), toggleClass:q(c.toggle), replaceClass:q(c.replace), empty:q(d.empty), removeAttr:q(h.remove), marginBox:p(f.getMarginBox), place:function(a, b) {
      var c = m(a)[0];
  ...
  define("lsmb/layout/TableContainer", "dojo/_base/kernel dojo/_base/lang dojo/_base/declare dojo/dom-class dojo/dom-construct dojo/_base/array dojo/dom-prop dojo/dom-style dijit/_WidgetBase dijit/layout/_LayoutWidget".split(" "), function(e, m, k, n, c, d, f, h, b, a) {
    e = k("lsmb.layout.TableContainer", a, {cols:1, labelWidth:"100", showLabels:!0, orientation:"horiz", spacing:1, customClass:"", postCreate:function() {
      ...
      if(this._initialized) {
        ...
        var s = c.create("tr", {}, p), w = !this.showLabels || "horiz" == this.orientation ? s : c.create("tr", {}, p), v = this.cols * (this.showLabels ? 2 : 1), t = 0;
        d.forEach(this._children, m.hitch(this, function(b, d) {
          var l = b.colspan || 1;
          1 < l && (l = this.showLabels ? Math.min(v - 1, 2 * l - 1) : Math.min(v, l));
          if(t + l - 1 + (this.showLabels ? 1 : 0) >= v) {
            t = 0, s = c.create("tr", {}, p), w = "horiz" == this.orientation ? s : c.create("tr", {}, p)
          }
          var e;
          if(this.showLabels) {
  ...
  define("exports ../errors/RequestError ../errors/CancelError ../Deferred ../io-query ../_base/array ../_base/lang ../promise/Promise".split(" "), function(e, m, k, n, c, d, f, h) {
    ...
    e.deferred = function(c, d, u, q, p, s) {
      ...
      w.isReady = q;
      w.handleResponse = p;
      u = w.then(b).otherwise(function(a) {
        a.response = c;
        throw a;
      });
      e.notify && u.then(f.hitch(e.notify, "emit", "load"), f.hitch(e.notify, "emit", "error"));
      q = u.then(a);
      p = new h;
      for(var v in q) {
  ...
  define(["./has"], function(e) {
    ...
    if(!h) {
      ...
      if(!e("dom-addeventlistener")) {
        ...
        try {
          u.doScroll && null === n.frameElement && g.push(function() {
            try {
              return u.doScroll("left"), 1
            }catch(a) {
            }
          })
        }catch(q) {
  ...
  define("dojo/_base/array dojo/_base/declare dojo/_base/fx dojo/dom dojo/dom-class dojo/dom-geometry dojo/dom-style dojo/_base/lang dojo/mouse dojo/on dojo/sniff ./_base/manager ./place ./_Widget ./_TemplatedMixin ./BackgroundIframe dojo/text!./templates/Tooltip.html ./main".split(" "), function(e, m, k, n, c, d, f, h, b, a, g, r, l, u, q, p, s, w) {
    ...
    var t = m("dijit._MasterTooltip", [u, q], {duration:r.defaultDuration, templateString:s, postCreate:function() {
      ...
      if(!this.aroundNode || !(this.aroundNode === b && this.containerNode.innerHTML == a)) {
        if("playing" == this.fadeOut.status()) {
          ...
          var n = l.around(this.domNode, b, c && c.length ? c : x.defaultPosition, !g, h.hitch(this, "orient")), t = n.aroundNodePos;
          "M" == n.corner.charAt(0) && "M" == n.aroundCorner.charAt(0) ? (this.connectorNode.style.top = t.y + (t.h - this.connectorNode.offsetHeight >> 1) - n.y + "px", this.connectorNode.style.left = "") : "M" == n.corner.charAt(1) && "M" == n.aroundCorner.charAt(1) ? this.connectorNode.style.left = t.x + (t.w - this.connectorNode.offsetWidth >> 1) - n.x + "px" : (this.connectorNode.style.left = "", this.connectorNode.style.top = "");
    ...
    g("dojo-bidi") && t.extend({_setAutoTextDir:function(a) {
      this.applyTextDir(a);
    ...
    w.showTooltip = function(a, b, c, g, d, l, f) {
      ...
      x._masterTT || (w._masterTT = x._masterTT = new t);
      return x._masterTT.show(a, b, c, g, d, l, f)
    };
    w.hideTooltip = function(a) {
      return x._masterTT && x._masterTT.hide(a)
    };
    var x = m("dijit.Tooltip", u, {label:"", showDelay:400, hideDelay:400, connectId:[], position:[], selector:"", _setConnectIdAttr:function(c) {
  ...
  define("./kernel ../Deferred ../promise/Promise ../errors/CancelError ../has ./lang ../when".split(" "), function(e, m, k, n, c, d, f) {
    var h = function() {
      ...
      var e, q, p, s, w, v, t, x = this.promise = new k;
      ...
      this.reject = this.errback = function(a) {
        w = !0;
        this.fired = s = 1;
        c("config-useDeferredInstrumentation") && m.instrumentRejected && m.instrumentRejected(a, !!t);
        f(a);
        this.results = [null, a]
      };
  ...
  define("./_base/kernel require ./_base/config ./aspect ./_base/lang ./topic ./domReady ./sniff".split(" "), function(e, m, k, n, c, d, f, h) {
    ...
    function u() {
      ...
      var h, p, n, u, r, s = this.iframe.location;
      ...
      this.pollLocation = function() {
        if(!r) {
          try {
            var e = b(s.href, "?");
            document.title != u && (u = this.iframe.document.title = document.title)
          }catch(k) {
    ...
    f(function() {
      "onhashchange" in e.global && (!h("ie") || 8 <= h("ie") && "BackCompat" != document.compatMode) ? s = n.after(e.global, "onhashchange", g, !0) : document.addEventListener ? (q = a(), setInterval(r, w)) : document.attachEvent && (p = new u)
    });
    return e.hash
  })
    ...
    if(!e("dom-matches-selector")) {
      var b = function() {
        ...
        return function(f, h, k) {
          var m = n[h];
          if(!m) {
            if(h.replace(/(?:\s*([> ])\s*)|(#|\.)?((?:\\.|[\w-])+)|\[\s*([\w-]+)\s*(.?=)?\s*("(?:\\.|[^"])+"|'(?:\\.|[^'])+'|(?:\\.|[^\]])*)\s*\]/g, function(f, h, k, v, n, t, w) {
              v ? m = d(m, e[k || ""](v.replace(/\\/g, ""))) : h ? m = (" " == h ? b : c)(m) : n && (m = d(m, a(n, w, t)));
              return""
            })) {
  ...
  define("dojo/_base/array dojo/aspect dojo/_base/declare dojo/dom dojo/dom-attr dojo/dom-construct dojo/dom-geometry dojo/dom-style dojo/has dojo/keys dojo/_base/lang dojo/on ./place ./BackgroundIframe ./Viewport ./main".split(" "), function(e, m, k, n, c, d, f, h, b, a, g, r, l, u, q, p) {
    function s() {
    ...
    k = k(null, {_stack:[], _beginZIndex:1E3, _idGen:1, _repositionAll:function() {
      ...
      b("config-bgIframe") && !k.bgIframe && (k.bgIframe = new u(J));
  ...
  define("require dojo/_base/array dojo/aspect dojo/_base/config dojo/_base/connect dojo/_base/declare dojo/dom dojo/dom-attr dojo/dom-class dojo/dom-construct dojo/dom-geometry dojo/dom-style dojo/has dojo/_base/kernel dojo/_base/lang dojo/on dojo/ready dojo/Stateful dojo/topic dojo/_base/window ./Destroyable dojo/has!dojo-bidi?./_BidiMixin ./registry".split(" "), function(e, m, k, n, c, d, f, h, b, a, g, r, l, u, q, p, s, w, v, t, x, z, y) {
    ...
    l.add("dijit-legacy-requires", !u.isAsync);
    l.add("dojo-bidi", !1);
    ...
    n = d("dijit._WidgetBase", [w, x], {id:"", _setIdAttr:"domNode", lang:"", _setLangAttr:A("lang"), dir:"", _setDirAttr:A("dir"), "class":"", _setClassAttr:{node:"domNode", type:"class"}, _setTypeAttr:null, style:"", title:"", tooltip:"", baseClass:"", srcNodeRef:null, domNode:null, containerNode:null, ownerDocument:null, _setOwnerDocumentAttr:function(a) {
      ...
      if(q.isFunction(d)) {
        ...
        var d = this.focusNode && !q.isFunction(this.focusNode) ? "focusNode" : "domNode", l = this[d] && this[d].tagName, f;
        if(f = l) {
          if(!(f = D[l])) {
            f = this[d];
            var e = {}, h;
  ...
  define(["./kernel", "../has", "./lang"], function(e, m, k) {
    ...
    function d(a) {
      var c = 1, d = 0, l = 0;
      a || (c = d = l = -1);
      return function(f, e, k, n) {
        if(n && 0 < c) {
          return b.lastIndexOf(f, e, k)
        }
        n = f && f.length || 0;
        var m = a ? n + l : d;
        k === h ? k = a ? d : n + l : 0 > k ? (k = n + k, 0 > k && (k = d)) : k = k >= n ? n + l : k;
        for(n && "string" == typeof f && (f = f.split(""));k != m;k += c) {
          if(f[k] == e) {
            return k
          }
        }
  ...
  define(["./has!dom-addeventlistener?:./aspect", "./_base/kernel", "./sniff"], function(e, m, k) {
    ...
    if(k("dom-addeventlistener")) {
      ...
      h._fixEvent = function(a, b) {
        ...
        if(!a.target) {
          switch(a.target = a.srcElement, a.currentTarget = b || a.srcElement, "mouseover" == a.type && (a.relatedTarget = a.fromElement), "mouseout" == a.type && (a.relatedTarget = a.toElement), a.stopPropagation || (a.stopPropagation = v, a.preventDefault = t), a.type) {
            case "keypress":
  ...
  define("./kernel ./config ./lang ../Evented ./Color ../aspect ../sniff ../dom ../dom-style".split(" "), function(e, m, k, n, c, d, f, h, b) {
    ...
    var u = 0, q = null, p = {run:function() {
    }};
    k.extend(l, {_startTimer:function() {
      this._timer || (this._timer = d.after(p, "run", k.hitch(this, "_cycle"), !0), u++);
      q || (q = setInterval(k.hitch(p, "run"), this.rate))
    }, _stopTimer:function() {
      this._timer && (this._timer.remove(), this._timer = null, u--);
      0 >= u && (clearInterval(q), q = null, u = 0)
    }});
  ...
  define("exports ./_base/kernel ./sniff ./_base/window ./dom ./dom-attr".split(" "), function(e, m, k, n, c, d) {
    ...
    var b = {option:["select"], tbody:["table"], thead:["table"], tfoot:["table"], tr:["table", "tbody"], td:["table", "tbody", "tr"], th:["table", "thead", "tr"], legend:["fieldset"], caption:["table"], colgroup:["table"], col:["table", "colgroup"], li:["ul"]}, a = /<\s*([\w\:]+)/, g = {}, r = 0, l = "__" + m._scopeName + "ToDomId", u;
    for(u in b) {
      b.hasOwnProperty(u) && (m = b[u], m.pre = "option" == u ? '\x3cselect multiple\x3d"multiple"\x3e' : "\x3c" + m.join("\x3e\x3c") + "\x3e", m.post = "\x3c/" + m.reverse().join("\x3e\x3c/") + "\x3e")
    }
    var q;
    8 >= k("ie") && (q = function(a) {
    ...
    var p = e.create = function(a, b, g, f) {
      var l = n.doc;
      g && (g = c.byId(g), l = g.ownerDocument);
  ...
  define("./_base/lang ./sniff ./_base/window ./dom ./dom-geometry ./dom-style ./dom-construct".split(" "), function(e, m, k, n, c, d, f) {
    ...
    var h = {getBox:function(b) {
      ...
      try {
        b = n.byId(b);
        var e = b.ownerDocument || k.doc, f = k.body(e), h = e.documentElement || f.parentNode, u = m("ie"), q = m("webkit");
        if(!(b == f || b == h)) {
          if(!m("mozilla") && (!u && !q && !m("opera") && !m("trident")) && "scrollIntoView" in b) {
            b.scrollIntoView(!1)
          }else {
            var p = "BackCompat" == e.compatMode, s = Math.min(f.clientWidth || h.clientWidth, h.clientWidth || f.clientWidth), w = Math.min(f.clientHeight || h.clientHeight, h.clientHeight || f.clientHeight), e = q || p ? f : h, v = a || c.position(b), t = b.parentNode, q = function(a) {
              return 6 >= u || 7 == u && p ? !1 : m("position-fixed-support") && "fixed" == d.get(a, "position").toLowerCase()
            ...
            if(!q(b)) {
              for(;t;) {
                t == f && (t = e);
                var y = c.position(t), A = q(t), D = "rtl" == d.getComputedStyle(t).direction.toLowerCase();
                if(t == e) {
                  y.w = s;
                  y.h = w;
                  if(e == h && (u || m("trident")) && D) {
                    y.x += e.offsetWidth - y.w
                  }
                  if(0 > y.x || !u || 9 <= u || m("trident")) {
                    y.x = 0
                  }
                  if(0 > y.y || !u || 9 <= u || m("trident")) {
                    y.y = 0
                  }
                }else {
                  var J = c.getPadBorderExtents(t);
                  y.w -= J.w;
                  y.h -= J.h;
                  y.x += J.l;
                  y.y += J.t;
                  var K = t.clientWidth, L = y.w - K;
                ...
                if(0 < F * M && (t.scrollLeft || t == e || t.scrollWidth > t.offsetHeight)) {
                  N = Math[0 > M ? "max" : "min"](M, F);
                  if(D && (8 == u && !p || 9 <= u || m("trident"))) {
                    N = -N
                  }
                  B = t.scrollLeft;
                  z(t, N, 0);
                ...
                if(0 < G * U && (t.scrollTop || t == e || t.scrollHeight > t.offsetHeight)) {
                  N = Math.ceil(Math[0 > U ? "max" : "min"](U, G)), B = t.scrollTop, z(t, 0, N), N = t.scrollTop - B, v.y -= N
                }
                t = t != e && !A && t.parentNode
              }
            }
          }
        }
  ...
  define("./kernel ../on ../topic ../aspect ./event ../mouse ./sniff ./lang ../keys".split(" "), function(e, m, k, n, c, d, f, h) {
    ...
    u = f("events-keypress-typed") ? function(a, b) {
    ...
    var q = {_keypress:u, connect:function(a, c, d, e, g) {
  ...
  define("../_base/lang ../_base/array ../date ../cldr/supplemental ../i18n ../regexp ../string ../i18n!../cldr/nls/gregorian module".split(" "), function(e, m, k, n, c, d, f, h, b) {
    ...
    l.parse = function(a, b) {
      ...
      var u = e.join(""), r = -1 != u.indexOf("d"), u = -1 != u.indexOf("M");
      if(!c || u && d.getMonth() > h[1] || r && d.getDate() > h[2]) {
        return null
      }
      if(u && d.getMonth() < h[1] || r && d.getDate() < h[2]) {
        d = k.add(d, "hour", 1)
      }
      return d
    };
  ...
  define("dojo/_base/array dojo/_base/declare dojo/dom-attr dojo/dom-class dojo/dom-geometry dojo/i18n dojo/keys dojo/_base/lang dojo/on dojo/sniff ./_FormSelectWidget ../_HasDropDown ../DropDownMenu ../MenuItem ../MenuSeparator ../Tooltip ../_KeyNavMixin ../registry dojo/text!./templates/Select.html dojo/i18n!./nls/validate".split(" "), function(e, m, k, n, c, d, f, h, b, a, g, r, l, u, q, p, s, w, v) {
    ...
    c = m("dijit.form.Select" + (a("dojo-bidi") ? "_NoBidi" : ""), [g, r, s], {baseClass:"dijitSelect dijitValidationTextBox", templateString:v, _buttonInputDisabled:a("ie") ? "disabled" : "", required:!1, state:"", message:"", tooltipPosition:[], emptyLabel:"\x26#160;", _isLoaded:!1, _childrenLoaded:!1, labelType:"html", _fillContent:function() {
      ...
      a = new u({option:a, label:("text" === this.labelType ? (a.label || "").toString().replace(/&/g, "\x26amp;").replace(/</g, "\x26lt;") : a.label) || this.emptyLabel, onClick:b, ownerDocument:this.ownerDocument, dir:this.dir, textDir:this.textDir, disabled:a.disabled || !1});
      ...
      if(!0 === a) {
        if(this.dropDown && (delete this.dropDown.focusedChild, this.focusedChild = null), this.options.length) {
          ...
          var b = new u({ownerDocument:this.ownerDocument, label:this.emptyLabel});
  ...
  define(["./kernel", "../has", "./lang"], function(e, m, k) {
    ...
    function w(e, f, m) {
      ...
      w.safeMixin(s, m);
      F = m.constructor;
      F !== t.constructor && (F.nom = A, s.constructor = F);
      for(z = E - 1;z;--z) {
        (F = B[z]._meta) && F.chains && (C = v(C || {}, F.chains))
      }
      s["-chains-"] && (C = v(C || {}, s["-chains-"]));
      F = !C || !C.hasOwnProperty(A);
      B[0] = G = C && "manual" === C.constructor ? u(B) : 1 == B.length ? l(m.constructor, F) : r(B, F);
    ...
    var v = k.mixin, t = Object.prototype, x = t.toString, z = new Function, y = 0, A = "constructor", D = e.config.isDebug ? f : c;
    e.safeMixin = w.safeMixin = function(a, b) {
      ...
      if(m("bug-for-in-skips-shadowed")) {
        for(var e = k._extraNames, g = e.length;g;) {
          if(c = e[--g], d = b[c], (d !== t[c] || !(c in t)) && c != A) {
            "[object Function]" == x.call(d) && (d.nom = c), a[c] = d
          }
        }
      }
  ...
  define("./_base/kernel ./has ./dom ./on ./_base/array ./_base/lang ./selector/_loader ./selector/_loader!default".split(" "), function(e, m, k, n, c, d, f, h) {
    ...
    var a = Array.prototype, g = a.slice, r = a.concat, l = c.forEach, u = function(a, b, c) {
    ...
    p._adaptAsMap = function(a, b) {
      return function() {
        return this.map(u(a, arguments, b))
      }
    };
    p._adaptAsForEach = function(a, b) {
      return function() {
        this.forEach(u(a, arguments, b));
        return this
      }
    };
    p._adaptAsFilter = function(a, b) {
      return function() {
        return this.filter(u(a, arguments, b))
      }
    };
    p._adaptWithCondition = function(a, b, c) {
      return function() {
        var d = arguments, g = u(a, d, c);
  ...
  define("dojo/_base/array dojo/dom dojo/dom-attr dojo/dom-style dojo/_base/lang dojo/sniff ./main".split(" "), function(e, m, k, n, c, d, f) {
    var h = {_isElementShown:function(b) {
      ...
      var c, e, f, m, n, p, s = {}, w = h._isElementShown, v = h.effectiveTabIndex, t = function(b) {
  ...
  define("dojo/_base/array dojo/date dojo/date/locale dojo/_base/declare dojo/dom-attr dojo/dom-class dojo/dom-construct dojo/_base/kernel dojo/keys dojo/_base/lang dojo/on dojo/sniff ./CalendarLite ./_Widget ./_CssStateMixin ./_TemplatedMixin ./form/DropDownButton".split(" "), function(e, m, k, n, c, d, f, h, b, a, g, r, l, u, q, p, s) {
    var w = n("dijit.Calendar", [l, u, q], {baseClass:"dijitCalendar", cssStateNodes:{decrementMonth:"dijitCalendarArrow", incrementMonth:"dijitCalendarArrow", previousYearLabelNode:"dijitCalendarPreviousYear", nextYearLabelNode:"dijitCalendarNextYear"}, setValue:function(a) {
    ...
    w._MonthDropDown = n("dijit.Calendar._MonthDropDown", [u, p, q], {months:[], baseClass:"dijitCalendarMonthMenu dijitMenu", templateString:"\x3cdiv data-dojo-attach-event\x3d'ondijitclick:_onClick'\x3e\x3c/div\x3e", _setMonthsAttr:function(a) {
  ...
  define("dojo/aspect dojo/_base/config dojo/_base/connect dojo/_base/declare dojo/has dojo/_base/kernel dojo/_base/lang dojo/query dojo/ready ./registry ./_WidgetBase ./_OnDijitClickMixin ./_FocusMixin dojo/uacss ./hccss".split(" "), function(e, m, k, n, c, d, f, h, b, a, g, r, l) {
    ...
    function q(a) {
      return function(b, c, d, e) {
        return b && "string" == typeof c && b[c] == u ? b.on(c.substring(2).toLowerCase(), f.hitch(d, e)) : a.apply(k, arguments)
      }
    }
    e.around(k, "connect", q);
    d.connect && e.around(d, "connect", q);
    e = n("dijit._Widget", [g, r, l], {onClick:u, onDblClick:u, onKeyDown:u, onKeyPress:u, onKeyUp:u, onMouseDown:u, onMouseMove:u, onMouseOut:u, onMouseOver:u, onMouseLeave:u, onMouseEnter:u, onMouseUp:u, constructor:function(a) {
      this._toConnect = {};
      for(var b in a) {
        this[b] === u && (this._toConnect[b.replace(/^on/, "").toLowerCase()] = a[b], delete a[b])
      }
    }, postCreate:function() {
      this.inherited(arguments);
      ...
      return this[this._onMap(a)] === u ? k.connect(this.domNode, a.toLowerCase(), this, b) : this.inherited(arguments)
  ...
  define("./_base/kernel ./aspect ./dom ./dom-class ./_base/lang ./on ./has ./mouse ./domReady ./_base/window".split(" "), function(e, m, k, n, c, d, f, h, b, a) {
    ...
    function l(b, c, e) {
      ...
      if(v = !b.target.disabled && f && f.dojoClick) {
        if(x = (t = "useTarget" == v) ? f : b.target, t && b.preventDefault(), z = b.changedTouches ? b.changedTouches[0].pageX - a.global.pageXOffset : b.clientX, y = b.changedTouches ? b.changedTouches[0].pageY - a.global.pageYOffset : b.clientY, A = ("object" == typeof v ? v.x : "number" == typeof v ? v : 0) || 4, D = ("object" == typeof v ? v.y : "number" == typeof v ? v : 0) || 4, !w) {
          w = !0;
          var g = function(b) {
            v = t ? k.isDescendant(a.doc.elementFromPoint(b.changedTouches ? b.changedTouches[0].pageX - a.global.pageXOffset : b.clientX, b.changedTouches ? b.changedTouches[0].pageY - a.global.pageYOffset : b.clientY), x) : v && (b.changedTouches ? b.changedTouches[0].target : b.target) == x && Math.abs((b.changedTouches ? b.changedTouches[0].pageX - a.global.pageXOffset : b.clientX) - z) <= A && Math.abs((b.changedTouches ? b.changedTouches[0].pageY - a.global.pageYOffset : b.clientY) - y) <= 
            D
          };
    ...
    q ? b(function() {
      ...
      d(a.doc, "touchmove", function(c) {
        K = (new Date).getTime();
        var e = a.doc.elementFromPoint(c.pageX - (u ? 0 : a.global.pageXOffset), c.pageY - (u ? 0 : a.global.pageYOffset));
      ...
      d(a.doc, "touchend", function(c) {
        K = (new Date).getTime();
        var e = a.doc.elementFromPoint(c.pageX - (u ? 0 : a.global.pageXOffset), c.pageY - (u ? 0 : a.global.pageYOffset)) || a.body();
