...
* Shipping
* Two-Factor Authentication (TOTP with Yubikey support)
* and more ...
...
security, compatible with authenticator apps like Google Authenticator, Authy,
and hardware tokens like Yubikey (both 6-digit and 8-digit codes supported).
